...
public class DataConfig {
    ...
    public LocalSessionFactoryBean sessionFactory() {
        ...
        sessionFactory.setPackagesToScan(env.getProperty("giflib.entity.package"));     // Retreives variable data from app.properties (similar to .env). env file set using @PropertySource
